...
public class MSearch {
    ...
    public MSearch(String id, String posterPath, String popularity, String title, String adult, String overview, String rilisDate, String voteAccount, String average) {
        this.id = id;
