...
import com.example.pangling.catalogmovie.adapter.AdapterNowPlaying;
...
public class NowPlayingFragment extends Fragment {
    ...
    ArrayList<MNowPlaying> data = new ArrayList<>();
    AdapterNowPlaying adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.rvNowPlaying);
    ...
    private void setData(){
        progressDialog.show();
        stringRequest = new StringRequest(Request.Method.GET, "https://api.themoviedb.org/3/movie/now_playing?api_key="+ Constans.API_KEY+"&language=en-US", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i< result.length(); i++){
                        ...
                        data.add(new MNowPlaying(id,path,popular,title,adults,overview,rilis,vote,average));
    ...
    private void setAdapter(){
        adapter = new AdapterNowPlaying(getContext(), data);
